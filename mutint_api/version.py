"""The version of mutint-api itself.
...
both fall back to the Django app label -- `mutint_api` -- so this is what makes a
component name itself after its repository, the way mutint-core does.

Bump it with `./mutint version --bump patch --component mutint-api`, and tag
